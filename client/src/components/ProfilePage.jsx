...
import { FiEdit, FiSave, FiCalendar, FiGlobe, FiUser, FiMail, FiClock } from 'react-icons/fi';
import { FaBaby, FaChild, FaUserAlt, FaHeartbeat } from 'react-icons/fa';
...
const ProfilePage = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      setIsEditing(false);
      // Recalculate pregnancy progress after update
  ...
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-50 p-4 md:p-8"
    >
        ...
        <div className="p-6 pt-12">
                ...
                <>
                  <div className="flex items-center">
                    ...
                    {isEditing ? (
                      ...
                      <span className="flex-1 font-medium">
                        {userData.pregnancyStartDate || 'Not specified'}
                      </span>
                    )}
                  </div>
                  <div className="flex items-center">
          ...
          <motion.div variants={itemVariants} className="mb-8">
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <span className="flex-1 font-medium">
                  {getLanguageName(userData.language)}
                </span>
              </div>
            </div>
          </motion.div>
          ...
          {userData.stage === 'pregnant' && weeksPregnant > 0 && (
            <motion.div 
              ...
              className="mb-8 bg-purple-50 rounded-lg p-4"
            >
      ...
      <motion.div 
        ...
        className="max-w-3xl mx-auto mt-6 grid grid-cols-1 md:grid-cols-2 gap-4"
      >
        <button
        ...
        >
          ...
          <div>
            <h3 className="font-medium text-gray-800">Update Pregnancy Stage</h3>
            <p className="text-sm text-gray-500">Change your current stage</p>
          </div>
        </button>
      </motion.div>

      {/* Pregnancy Milestones Animation */}
      {userData.stage === 'pregnant' && (
        <motion.div
